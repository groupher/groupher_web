defmodule GroupherServer.Repo.Migrations.CreateWallpaperSnapshots do
  use Ecto.Migration

  @prefix "cms"

  def change do
    create table(:wallpaper_snapshots, prefix: @prefix) do
    ...
    create(unique_index(:wallpaper_snapshots, [:public_ref], prefix: @prefix))
    create(index(:wallpaper_snapshots, [:community_id, :theme], prefix: @prefix))
    create(index(:wallpaper_snapshots, [:community_id, :history_used_at], prefix: @prefix))

    create table(:wallpaper_snapshot_images, prefix: @prefix) do
      add(
    ...
    create(index(:wallpaper_snapshot_images, [:asset_public_ref], prefix: @prefix))

    create table(:community_wallpapers, prefix: @prefix) do
      add(:community_id, references(:communities, prefix: @prefix, on_delete: :delete_all),
        null: false
      )
    ...
    create(unique_index(:community_wallpapers, [:community_id], prefix: @prefix))
    create(unique_index(:community_wallpapers, [:public_ref], prefix: @prefix))

    create table(:wallpaper_publish_receipts, prefix: @prefix) do
      add(:community_id, references(:communities, prefix: @prefix, on_delete: :delete_all),
        null: false
      )
    ...
    create(index(:wallpaper_publish_receipts, [:expires_at], prefix: @prefix))
  end
end
