...
const SVG = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-3.2 -3.2 38.4 38.4" {...props}>
      <rect
        width={38.4}
        height={38.4}
        x={-3.2}
