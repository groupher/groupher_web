...
const UserVoice: FC = () => {
  ...
  return (
    <Wrapper>
      <Parallax speed={speed} rotate={[8, 0]} translateY={[0, 0]} disabled={isMobile}>
        <VoiceCard color={COLOR_NAME.ORANGE} uname="XY" text="提了一个需求" />
      </Parallax>
      <Parallax speed={speed} rotate={[3, 0]} translateY={[0, 0]} disabled={isMobile}>
        <VoiceCard color={COLOR_NAME.PURPLE} uname="MV" text="发现一个 Bug" />
      </Parallax>
      <Parallax speed={speed} rotate={[-5, 0]} translateY={[0, 0]} disabled={isMobile}>
        <VoiceCard color={COLOR_NAME.RED} uname="MJ" text="想投票给一个功能" />
      </Parallax>
      <Parallax speed={speed} rotate={[-4, 0]} translateY={[0, 0]} disabled={isMobile}>
        <VoiceCard color={COLOR_NAME.ORANGE} uname="XY" text="使用有点疑惑" />
      </Parallax>
      <Parallax speed={speed} rotate={[6, 0]} translateY={[0, 0]} disabled={isMobile}>
      ...
      <Parallax speed={speed} rotate={[7, 0]} translateY={[0, 0]} disabled={isMobile}>
