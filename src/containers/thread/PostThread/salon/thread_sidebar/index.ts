...
export default () => {
  ...
  return {
    ...
    title: cn('row-center text-sm bold mb-2.5', fg('article.digest')),
    desc: cn('text-sm mb-2.5 line-clamp-2 leading-normal', fg('article.digest')),
    homeLinks: 'row-center text-sm bold-sm truncate max-w-52 mb-5',
